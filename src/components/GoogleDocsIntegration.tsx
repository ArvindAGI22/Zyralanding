        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-xl text-gray-300 leading-relaxed mb-8 font-medium">
              Zyra creates, edits, and manages your Google Docs with voice commands. 
              From drafting reports to collaborative editing — your documents stay organized and accessible.
            </p>
            
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 bg-blue-500 rounded-full mt-3"></div>
                <p className="text-gray-300 font-medium">Voice-to-text document creation and editing</p>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 bg-blue-500 rounded-full mt-3"></div>
                <p className="text-gray-300 font-medium">Smart formatting and structure suggestions</p>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 bg-blue-500 rounded-full mt-3"></div>
                <p className="text-gray-300 font-medium">Automatic sharing and collaboration setup</p>
              </div>
            </div>
          </div>
          
          {/* Right Column - Google Docs Interface Image */}
          <div className="relative">
            <div className="relative max-w-2xl mx-auto">
              ...
              <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-gradient-to-r from-blue-600 to-blue-500 rounded-2xl flex items-center justify-center shadow-lg">
